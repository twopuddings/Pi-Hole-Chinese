            ...
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <div class="alFailure text-bold text-red" style="display: none">
                        <span id="alNetErr">超时或者网络出错!</span>
    ...
    <div class="col-md-12">
      <div class="box" id="recent-queries">
        <div class="box-header with-border">
          <h3 class="box-title">最近的请求 <?php echo $showing; ?></h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            ...
            <label><input type="checkbox" id="autofilter" checked="true">&nbsp;对单击类型、域和客户端应用筛选</label><br/>

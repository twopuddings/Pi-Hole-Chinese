        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">自定义禁用超时</h4>
                </div>
...
?>
	...
	<!-- Version Infos -->
        ...
        <div style="display: inline-block"><strong><a href="https://pi-hole.net/donate" target="_blank"><i class="fa fa-heart"></i> 捐赠</a></strong> 如果你觉得这个有用的话。由两口布丁翻译</div>
    </footer>
</div>
<!-- ./wrapper -->

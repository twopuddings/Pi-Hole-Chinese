                        ...
                        <ul class="dropdown-menu" style="right:0">
                            ...
                            <li class="user-body">
                                ...
                                <div class="col-xs-12 text-center" id="sessiontimer">
                                    <b>会话对以下内容有效 <span id="sessiontimercounter"><?php if($auth && strlen($pwhash) > 0){echo $maxlifetime;}else{echo "0";} ?></span></b>
                                </div>
                            </li>
                            <!-- Menu Footer -->
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview<?php if($scriptname === "db_queries.php" || $scriptname === "db_lists.php" || $scriptname === "db_graph.php"){ ?> active<?php } ?>">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li<?php if($scriptname === "db_lists.php"){ ?> class="active"<?php } ?>>
                        <a href="db_lists.php">
                            <i class="fa fa-file-alt"></i> <span>最新列表</span>
                        </a>
                    </li>
                  </ul>
                </li>
                  ...
                  <ul class="treeview-menu">
                    <li>
                        <a href="#" id="pihole-disable-permanently">
                            <i class="fa fa-stop"></i> <span>永久地</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" id="pihole-disable-10s">
                            <i class="fa fa-clock"></i> <span>10秒钟</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" id="pihole-disable-30s">
                            <i class="fa fa-clock"></i> <span>30秒钟</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" id="pihole-disable-5m">
                            <i class="fa fas fa-clock"></i> <span>5分钟</span>
                        </a>
                    </li>
                    <li>
                ...
                <li id="pihole-enable" class="treeview"<?php if ($pistatus == "1") { ?> hidden="true"<?php } ?>>
                    <a href="#"><i class="fa fa-play"></i> <span id="enableLabel">开启&nbsp;&nbsp;&nbsp;<span id="flip-status-enable"></span></span></a>
                </li>
                <!-- Tools -->
                <li class="treeview <?php if(in_array($scriptname, array("gravity.php", "queryads.php", "auditlog.php", "taillog.php", "taillog-FTL.php", "debug.php"))){ ?>active<?php } ?>">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li<?php if($scriptname === "gravity.php"){ ?> class="active"<?php } ?>>
                        <a href="gravity.php">
                            <i class="fa fa-arrow-circle-down"></i> <span>更新订阅</span>
                        </a>
                    </li>
                    <!-- Query Lists -->
                    ...
                    <li<?php if($scriptname === "taillog.php"){ ?> class="active"<?php } ?>>
                        <a href="taillog.php">
                            <i class="fa fa-list-ul"></i> <span>追踪 pihole.log</span>
                        </a>
                    </li>
                    <!-- Tail pihole-FTL.log -->
                    <li<?php if($scriptname === "taillog-FTL.php"){ ?> class="active"<?php } ?>>
                        <a href="taillog-FTL.php">
                            <i class="fa fa-list-ul"></i> <span>追踪 pihole-FTL.log</span>
                        </a>
                    </li>
                    <!-- Generate debug log -->
                ...
                <li>
                    <a href="?logout">
                        <i class="fa fa-user-times"></i> <span>登出</span>
                    </a>
                </li>
                <?php } ?>
                <?php } ?>
